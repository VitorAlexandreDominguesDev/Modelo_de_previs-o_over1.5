...
def redeNeural(nome, momentum, lr, epocas, hiddenSize, datasetNome):
    ...
    # Selecionar colunas relevantes para treinar o modelo
    colunas = ['HomeTeam', 'AwayTeam', 'Over1.5',
    ...
    # Preparar dados para o teste e treino
    media_times = df.iloc[10:20]
    ...
    torch.save(model.state_dict(), "modeloTreinadoOver1_5.pth")
